...
namespace mltk{
    namespace classifier {
        ...
        int SMO<T>::take_step(int i1, int i2) {
            ...
            if (min_val == max_val) {
                if (this->verbose > 2) cout << "return0 2\n";
                return false;
            }
            ...
            if (this->verbose > 1)
                cout << "Total error= " << error_tot << ", alpha(" << i1 << ")= " << new_alpha1 << ", alpha(" << i2
                     << ")= " << new_alpha2 << endl;
        ...
        *----------------------------------------------------------*/
        ...
        template
        class SMO<long long int>;

        template
        class SMO<short int>;

        template
        class SMO<long double>;

        template
        class SMO<unsigned char>;

        template
        class SMO<unsigned int>;

        template
        class SMO<unsigned short int>;
    }
}