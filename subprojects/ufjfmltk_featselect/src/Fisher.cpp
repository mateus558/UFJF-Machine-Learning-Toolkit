...
namespace mltk{
    namespace featselect {
        ...
        template
        class Fisher<long long int>;

        template
        class Fisher<short int>;

        template
        class Fisher<long double>;

        template
        class Fisher<unsigned char>;

        template
        class Fisher<unsigned int>;

        template
        class Fisher<unsigned short int>;
    }
}