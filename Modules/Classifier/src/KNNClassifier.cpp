...
namespace mltk{
        namespace classifier {
            ...
            template
            class KNNClassifier<int>;

            template
            class KNNClassifier<double>;

            template
            class KNNClassifier<float>;

            template
            class KNNClassifier<int8_t>;

            template
            class KNNClassifier<char>;

            template
            class KNNClassifier<long long int>;

            template
            class KNNClassifier<short int>;

            template
            class KNNClassifier<long double>;

            template
            class KNNClassifier<unsigned char>;

            template
            class KNNClassifier<unsigned int>;

            template
            class KNNClassifier<unsigned short int>;
        }
}